...
gross_churn_agg AS (
    ...
    WHERE lag_1_week_mark_status = 'Not Working'
      AND lag_2_week_mark_status = 'Not Working'
      AND lag_3_week_mark_status = 'Working'
    GROUP BY 1, 2
),

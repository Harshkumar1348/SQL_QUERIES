-- DYNAMIC Pivoted View: Weeks as Columns with Trainer Performance Metrics
-- This version automatically pivots all weeks in your data
...
-- Use Snowflake PIVOT to transpose weeks to columns
SELECT *
FROM weekly_metrics
PIVOT (
    MAX(total_elc_trainers) AS total_elc,
    MAX(trainers_score_gt_75) AS score_gt_75,
    MAX(trainers_elc_pip_lt_20) AS elc_pip_lt_20,
    MAX(trainers_lt_60_days) AS lt_60_days
    FOR week IN (

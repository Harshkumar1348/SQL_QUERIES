-- Pivoted View: Weeks as Columns with Trainer Performance Metrics
-- Metrics: Total ELC Trainers, Score>75, ELC PIP<20%, Trainers<60 days
...
base_data AS (
    SELECT 
        ...
        elc_pip_pct,
        CASE 
            WHEN elc_pip_pct < 20 THEN 'Less Than 20'
            ELSE 'Greater than 20'
        END AS ELC_PIP_LESS_20,
        hh_pros_avg_rating,
        score,
        CASE 
            WHEN score > 75 THEN 'Greater than 75'
            ELSE 'Less than 75'
        END AS score_range,
...
weekly_metrics AS (
    SELECT 
        ...
        COUNT(DISTINCT CASE WHEN elc_pip_pct < 20 THEN trainer END) AS trainers_elc_pip_lt_20,
        COUNT(DISTINCT CASE WHEN age_tm = 'ELC Trainer' THEN trainer END) AS trainers_lt_60_days
    FROM base_data
    GROUP BY week
)

-- PIVOT: Weeks as columns, metrics as rows
SELECT 
    'Total ELC Trainers' AS metric,
    ...
    MAX(CASE WHEN week = '2025-01-20' THEN total_elc_trainers END) AS "2025-01-20",
    MAX(CASE WHEN week = '2025-01-27' THEN total_elc_trainers END) AS "2025-01-27",
    MAX(CASE WHEN week = '2025-02-03' THEN total_elc_trainers END) AS "2025-02-03"
FROM weekly_metrics

UNION ALL

SELECT 
    'Trainers with Score > 75' AS metric,
    MAX(CASE WHEN week = '2025-01-06' THEN trainers_score_gt_75 END) AS "2025-01-06",
    MAX(CASE WHEN week = '2025-01-13' THEN trainers_score_gt_75 END) AS "2025-01-13",
    MAX(CASE WHEN week = '2025-01-20' THEN trainers_score_gt_75 END) AS "2025-01-20",
    MAX(CASE WHEN week = '2025-01-27' THEN trainers_score_gt_75 END) AS "2025-01-27",
    MAX(CASE WHEN week = '2025-02-03' THEN trainers_score_gt_75 END) AS "2025-02-03"
FROM weekly_metrics

UNION ALL

SELECT 
    'Trainers with ELC PIP % < 20' AS metric,
    MAX(CASE WHEN week = '2025-01-06' THEN trainers_elc_pip_lt_20 END) AS "2025-01-06",
    MAX(CASE WHEN week = '2025-01-13' THEN trainers_elc_pip_lt_20 END) AS "2025-01-13",
    MAX(CASE WHEN week = '2025-01-20' THEN trainers_elc_pip_lt_20 END) AS "2025-01-20",
    MAX(CASE WHEN week = '2025-01-27' THEN trainers_elc_pip_lt_20 END) AS "2025-01-27",
    MAX(CASE WHEN week = '2025-02-03' THEN trainers_elc_pip_lt_20 END) AS "2025-02-03"
FROM weekly_metrics

UNION ALL

SELECT 
    'Trainers < 60 Days' AS metric,
    MAX(CASE WHEN week = '2025-01-06' THEN trainers_lt_60_days END) AS "2025-01-06",
    MAX(CASE WHEN week = '2025-01-13' THEN trainers_lt_60_days END) AS "2025-01-13",
    MAX(CASE WHEN week = '2025-01-20' THEN trainers_lt_60_days END) AS "2025-01-20",
    MAX(CASE WHEN week = '2025-01-27' THEN trainers_lt_60_days END) AS "2025-01-27",
    MAX(CASE WHEN week = '2025-02-03' THEN trainers_lt_60_days END) AS "2025-02-03"
FROM weekly_metrics
ORDER BY metric;

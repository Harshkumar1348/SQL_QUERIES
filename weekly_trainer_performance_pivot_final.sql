-- FINAL Pivoted View: Weeks as Columns with Trainer Performance Metrics
-- This version uses conditional aggregation to show all weeks dynamically
-- Metrics: Total ELC Trainers, Score>75, ELC PIP<20%, Trainers<60 days

-- NOTE: This query shows weeks as rows with metrics as columns.
-- For true pivot (weeks as columns), you'll need to update the MAX(CASE...) 
-- statements with your specific week dates.
...
-- Final aggregated view with weeks as rows and metrics as columns
SELECT 
    week AS "Week",

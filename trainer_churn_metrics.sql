...
churn_by_trainer AS (
    SELECT
        ...
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '3. D0 churn'     THEN cb.provider_id END) AS d0_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '4. D7 churn'     THEN cb.provider_id END) AS d7_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '5. D15 churn'    THEN cb.provider_id END) AS d15_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '6. D30 churn'    THEN cb.provider_id END) AS d30_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '7. D60 churn'    THEN cb.provider_id END) AS d60_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '8. D90 churn'    THEN cb.provider_id END) AS d90_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '9. D120 churn'   THEN cb.provider_id END) AS d120_churn_count,
        COUNT(DISTINCT CASE WHEN cb.churn_bucket_label = '10. >D120 churn' THEN cb.provider_id END) AS gt_d120_churn_count
...
SELECT
    ...
    COALESCE(c.d0_churn_count, 0)         AS d0_churn_count,
    COALESCE(c.d7_churn_count, 0)         AS d7_churn_count,
    COALESCE(c.d15_churn_count, 0)        AS d15_churn_count,
    COALESCE(c.d30_churn_count, 0)        AS d30_churn_count,
    COALESCE(c.d60_churn_count, 0)        AS d60_churn_count,
    COALESCE(c.d90_churn_count, 0)        AS d90_churn_count,
    COALESCE(c.d120_churn_count, 0)       AS d120_churn_count,
    COALESCE(c.gt_d120_churn_count, 0)    AS gt_d120_churn_count
FROM combined a
LEFT JOIN tm_age t

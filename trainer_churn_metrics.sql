...
-- ============================================================
-- VIEW3: Churn metrics per trainer per week
-- Uses l7d (last 7 days calendar working status) and ranked
-- (temp block status) to classify churn, then counts churn
-- partners per trainer per week.
-- ============================================================
view3 AS (
...
-- ============================================================
-- Final output: trainer scorecard + churn count per week
-- ============================================================
SELECT DISTINCT

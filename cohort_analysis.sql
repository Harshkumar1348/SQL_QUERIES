...
select c.provider_id,c.city,c.cohort, c.PRO_AGE, case 
...
SELECT
    ...
    -- Language Cohort ELC
    CASE 
        WHEN SUM(CASE WHEN cohort = 'language Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(total_rated_jobs, 0) ELSE 0 END) = 0 THEN NULL
        ELSE SUM(CASE WHEN cohort = 'language Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(avg_rating, 0) * COALESCE(total_rated_jobs, 0) ELSE 0 END)
    ...
    CASE 
        WHEN SUM(CASE WHEN cohort = 'Foundational Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(total_rated_jobs, 0) ELSE 0 END) = 0 THEN NULL
        ELSE SUM(CASE WHEN cohort = 'Foundational Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(avg_rating, 0) * COALESCE(total_rated_jobs, 0) ELSE 0 END)
    ...
    -- No Cohort ELC
    CASE 
        WHEN SUM(CASE WHEN cohort = 'No Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(total_rated_jobs, 0) ELSE 0 END) = 0 THEN NULL
        ELSE SUM(CASE WHEN cohort = 'No Cohort' AND PRO_AGE = 'ELC' THEN COALESCE(avg_rating, 0) * COALESCE(total_rated_jobs, 0) ELSE 0 END)

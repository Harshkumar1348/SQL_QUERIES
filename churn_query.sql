...
provider_name,
city,
avg_rating, MAX(last_delivery_date) as ldd,
...
CASE 
    ...
    WHEN b.ldd IS NULL AND b.app_date >= CURRENT_DATE - 7 THEN 'active'
    ELSE 'churn' 
END AS churn_status,
...
from base b 
LEFT JOIN l7d on b.provider_id = l7d.provider_id
